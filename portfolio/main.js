document.addEventListener('DOMContentLoaded', function() {
    ...
    const coloredThemeToggle = document.getElementById('coloredThemeToggle');
    ...
    function applyTheme() {
        ...
        if (coloredThemeToggle.checked) {
            if (themeToggle.checked) {
                body.classList.add('colored-dark-theme');
                body.classList.remove('colored-light-theme');
            } else {
                body.classList.add('colored-light-theme');
                body.classList.remove('colored-dark-theme');
            }
        } else {
            body.classList.remove('colored-light-theme', 'colored-dark-theme');
        }
    }

    applyTheme();
    themeToggle.addEventListener('change', applyTheme);
    coloredThemeToggle.addEventListener('change', applyTheme);
